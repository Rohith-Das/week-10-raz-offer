...
const placeOrder = async (req, res) => {
  try {
    ...
    const { shippingAddress, paymentMethod, razorpay_payment_id, razorpay_order_id, razorpay_signature } = req.body;
    ...
    for (const item of cart.items) {
      ...
      console.log('Selected Discount:', bestDiscount, 'Discounted Price:', discountedPrice);
...
const orderSummary = async (req, res) => {
  try {
    ...
    // The total amount is already calculated and stored when the order is placed
